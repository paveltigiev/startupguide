        ...
        <el-col :xs="24" :sm="18" :lg="18">
          ...
          <el-row :gutter="20">
            ...
            <el-col :xs="24" :sm="12" :lg="8">
              ...
              <div class="startup-year">
                {{supportentity.min}} - {{supportentity.max}}
              </div>
            </el-col>
          </el-row>
        </el-col>
...
export default {
  ...
  computed: {
    supportentity () {
      return this.$store.getters.supportentity
    }
  },
  methods: {
  },
  ...
  created() {
    this.$store.dispatch('getSupportentity', this.id)
  }
}
</script>
